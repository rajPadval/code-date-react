...
const Profile = () => {
  ...
  const getUsers = async () => {
    const res = await axios.get("https://code-date-api.onrender.com/api/getUsers");
  ...
  const addToFav = async (id) => {
    const res = await axios.put("https://code-date-api.onrender.com/api/addToFav/" + id);
    const data = await res.data;
  ...
  const addToDis = async (id) => {
    const res = await axios.put("https://code-date-api.onrender.com/api/addToDis/" + id);
    const data = await res.data;
    if (data.success === true) {
      toast.success(data.message);
      nextProfile();
